...
Cheese.create!(name: 'Provolone', price: 4, is_best_seller: true)
Cheese.create!(name: 'Parmesan', price: 3, is_best_seller: true)
Cheese.create!(name: 'feta', price: 5, is_best_seller: false)